# Paid pilot: GitHub Actions cost-risk audit
...
- a prioritized list of runner, matrix, timeout, concurrency, and artifact-retention changes;
- transparent assumptions for configured cost-exposure estimates; and
- one written follow-up covering the report.

No repository token is required. You can provide sanitized workflow files or run the public CLI and send its JSON. Please do not send application code, production secrets, private logs, or live credentials.
